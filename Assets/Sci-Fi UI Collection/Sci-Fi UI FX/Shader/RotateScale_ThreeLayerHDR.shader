Shader "UIRotateScaleFX/ThreeLayerHDR"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float fadeAlpha1, fadeAlpha2, fadeAlpha3;
                ...
                a = c3.a + result.a * (1 - c3.a);
                rgb = (c3.rgb * c3.a + result.rgb * result.a * (1 - c3.a)) / max(a, 0.0001);
                result = half4(rgb, a);
