Shader "UIAnimFX/H_EightLayerHDR"
{
    Properties
    {
        ...
        _Layer6Speed ("Layer 6 Speed", Float) = 0
        _Layer6Angle ("Layer 6 Move Angle (Degrees)", Range(0, 360)) = 0
        
        _Layer7Tex ("Layer 7 Texture", 2D) = "white" {}
        [HDR] _Layer7Color ("Layer 7 Color", Color) = (1,1,1,1)
        _Layer7Speed ("Layer 7 Speed", Float) = 0
        _Layer7Angle ("Layer 7 Move Angle (Degrees)", Range(0, 360)) = 0
        
        _Layer8Tex ("Layer 8 Texture", 2D) = "white" {}
        [HDR] _Layer8Color ("Layer 8 Color", Color) = (1,1,1,1)
        _Layer8Speed ("Layer 8 Speed", Float) = 0
        _Layer8Angle ("Layer 8 Move Angle (Degrees)", Range(0, 360)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                bool layer6Valid = layer6UVBase.y != 0.0 && layer6UVBase.y != 1.0;
                bool layer7Valid = layer7UVBase.y != 0.0 && layer7UVBase.y != 1.0;
                bool layer8Valid = layer8UVBase.y != 0.0 && layer8UVBase.y != 1.0;
